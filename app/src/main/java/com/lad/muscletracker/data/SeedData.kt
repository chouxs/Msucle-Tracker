...
object SeedData {
    ...
    fun getDefaultExercises(): List<Exercise> = listOf(
        ...
        Exercise(name = "Iso Lateral Bench Press", muscleGroup = "Pecs", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Iso Lateral Incline Press", muscleGroup = "Pecs", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Chest press machine", muscleGroup = "Pecs", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        ...
        Exercise(name = "Iso Lateral High Row", muscleGroup = "Dos", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Iso Lateral Low Row", muscleGroup = "Dos", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Iso Lateral Wide Pulldown", muscleGroup = "Dos", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Iso Lateral DY Row", muscleGroup = "Dos", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        ...
        Exercise(name = "Iso Lateral Shoulder Press", muscleGroup = "Epaules", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Shoulder press machine", muscleGroup = "Epaules", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Lateral raise machine", muscleGroup = "Epaules", targetSets = 3, targetRepsMin = 10, targetRepsMax = 15, restSeconds = 75, exerciseType = "isolation"),
        ...
        Exercise(name = "V-Squat", muscleGroup = "Jambes", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
        Exercise(name = "Belt squat", muscleGroup = "Jambes", targetSets = 4, targetRepsMin = 6, targetRepsMax = 10, restSeconds = 120, exerciseType = "compound"),
